...
function App() {
  ...
  return (
    ...
    >
      <Dock onWindowsChange={handleWindowsChange} />

      <header className="fixed top-0 left-0 right-0 z-50 p-4 flex justify-center transition-all duration-300 status-bar-header">
        <StatusBar
          windows={windows}
